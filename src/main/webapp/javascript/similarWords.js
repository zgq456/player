...
function getSimilarWords(id) {
	window.open("play.do?action=getSimilarList&id=" + id);
}
...
$(document)
		.ready(
				function() {
					var sourceWord = GetArgsFromHref(window.location.href, "word");
//					alert("sourceWord:" + sourceWord);
					jQuery("#grid-table")
							.jqGrid(
									{
										url : "play.do?action=getSimilarList&id=" + GetArgsFromHref(window.location.href, "id"),
										...
										caption : sourceWord  + "'s Similar Words List",
										subGrid : true,
